...
def create_bldg_obj(dict_dir,bldg_tag,pname_key):
    ...
    for sig_tag in sig_tag_set:
        ...
        for k,effect_idx in enumerate(p_idx):
            ...
            exec(cmd_str_)
    cmd_str_='mt.saveObjectBinaryFast('+bldg_tag+',\''+PROC_OUT_DIR+bldg_tag+'.bin\')'
    exec(cmd_str_)
                ...
                if sig_tag in anal_out.__dict__.keys():
                    ...
                    for p_name in p_name_sets:
                        ...
                        try:
                            ...
                            png_id = get_pngid()
                            oname = BN_ANALYSIS_PNG+bldg_tag+'_'+pname_+'_'+sig_tag+'_bn_sensors'+png_id+'.png'
                            tname = BN_ANALYSIS_PNG_THUMB+bldg_tag+'_'+pname_+'_'+sig_tag+'_bn_sensors'+png_id+'.png'
                            plt.savefig(oname, bbox_inches='tight')
                            plt.close()
                            image.thumbnail(oname, tname, scale=0.026)
                        ...
                        try:
                            ...
                            png_id = get_pngid()
                            oname = BN_ANALYSIS_PNG+bldg_tag+'_'+pname_+'_'+sig_tag+'_bn_time'+png_id+'.png'
                            tname = BN_ANALYSIS_PNG_THUMB+bldg_tag+'_'+pname_+'_'+sig_tag+'_bn_time'+png_id+'.png'
                            plt.savefig(oname, bbox_inches='tight')
                            plt.close()
                            image.thumbnail(oname, tname, scale=0.026)
                        ...
                        try:
                            ...
                            png_id = get_pngid()
                            oname = BN_ANALYSIS_PNG+bldg_tag+'_'+pname_+'_'+sig_tag+'_bn_weather'+png_id+'.png'
                            tname = BN_ANALYSIS_PNG_THUMB+bldg_tag+'_'+pname_+'_'+sig_tag+'_bn_weather'+png_id+'.png'
                            plt.savefig(oname, bbox_inches='tight')
                            plt.close()
                            image.thumbnail(oname, tname, scale=0.026)
                        ...
                        try:
                            ...
                            png_id = get_pngid()
                            oname = BN_ANALYSIS_PNG+bldg_tag+'_'+pname_+'_'+sig_tag+'_bn_sensor_time_weather'+png_id+'.png'
                            tname = BN_ANALYSIS_PNG_THUMB+bldg_tag+'_'+pname_+'_'+sig_tag+'_bn_sensor_time_weather'+png_id+'.png'
                            plt.savefig(oname, bbox_inches='tight')
                            plt.close()
                            image.thumbnail(oname, tname, scale=0.026)
                        ...
                        try:
                            ...
                            png_id = get_pngid()
                            oname = LH_ANALYSIS_PNG+bldg_tag+'_'+pname_+'_'+sig_tag+'_LH_sensor_time_weather'+png_id+'.png'
                            tname = LH_ANALYSIS_PNG_THUMB+bldg_tag+'_'+pname_+'_'+sig_tag+'_LH_sensor_time_weather'+png_id+'.png'
                            plt.savefig(oname, bbox_inches='tight')
                            plt.close()
                            image.thumbnail(oname, tname, scale=0.026)
