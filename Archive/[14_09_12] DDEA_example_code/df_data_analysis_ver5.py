...
figure('a_21200112')
a_21200112=mt.loadObjectBinaryFast('21200112.bin')
a_21200112_t=[temp[0] for temp in a_21200112['ts']]
a_21200112_val= a_21200112['value']
s_idx=bldg_.GSBC_.avg.sensor_names.index('a_21200112')

plot(bldg_.GSBC_.avg.time_slot, bldg_.GSBC_.avg.data_state_mat[:,s_idx])
plot(a_20242206_t,a_20242206_val,'s')

for idx in range(100):
    plot(bldg_.GSBC_.avg.time_slot, bldg_.GSBC_.avg.data_state_mat[:,idx],'.')
