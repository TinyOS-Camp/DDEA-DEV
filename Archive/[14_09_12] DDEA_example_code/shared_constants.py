...
Gvalley_data_dir='/mnt/adsc_smartgrid/gvalley/Binfiles_13011311/'
Gvalley_weather_dir='/mnt/adsc_smartgrid/gvalley/weather/gvalley_'
VTT_out_dir='./VTT/'
#VTT_data_dir=/'/mntadsc_smartgrid/VTT/Binfiles/'
#VTT_weather_dir='/mnt/adsc_smartgrid/VTT/weather/vtt_'
VTT_data_dir='/media/TOSHIBA_EXT/KMEG_BigData/VTT/Binfiles/'
VTT_weather_dir='/media/TOSHIBA_EXT/KMEG_BigData/VTT/weather/VTT_'
GSBC_out_dir='./GSBC/'
#GSBC_data_dir='/mnt/adsc_smartgrid/gsbc/Binfiles/'
#GSBC_weather_dir='/mnt/adsc_smartgrid/gsbc/weather/gsbc_'
