...
VTT_data_dir='/data/bigdata/VTT/Binfiles/'
VTT_weather_dir='/data/bigdata/VTT/weather/VTT_'
GSBC_out_dir='./GSBC/'
GSBC_data_dir='/data/bigdata/gsbc/Binfiles/'
GSBC_weather_dir='/data/bigdata/gsbc/weather/gsbc_'
