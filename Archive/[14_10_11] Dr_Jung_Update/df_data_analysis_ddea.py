...
def ddea_analysis(sensor,start_date,end_date):
    ...
    for bldg_key in bldg_key_set:
        ...
        if IS_USING_SAVED_DICT==0:
            ...
            construct_data_dict(input_file_to_be_included,ANS_START_T,ANS_END_T,TIMELET_INV,binfilename=PROC_OUT_DIR+'data_dict',IS_USING_PARALLEL=IS_USING_PARALLEL_OPT)
