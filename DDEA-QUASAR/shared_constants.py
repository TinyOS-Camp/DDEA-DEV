...
CPU_CORE_NUM = multiprocessing.cpu_count() / 2

# Getting weather data from locally stored bin files if True
USE_WEATHER_DATA_BIN = True

PROC_OUT_DIR = '/home/almightykim/DDEA/VTT/proc_out/'
DATA_DIR = '/home/almightykim/DDEA/VTT/Binfiles/'
WEATHER_DIR = '/home/almightykim/DDEA/VTT/weather/VTT_'
FIG_DIR = '/home/almightykim/DDEA/VTT/png_files/'
FL_EXT = '.bin'
